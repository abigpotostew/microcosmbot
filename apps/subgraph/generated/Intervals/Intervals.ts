...
export class IntervalsInitialized extends ethereum.Event {
  get params(): IntervalsInitialized__Params {
    return new IntervalsInitialized__Params(this);
  }
}

export class IntervalsInitialized__Params {
  _event: IntervalsInitialized;

  constructor(event: IntervalsInitialized) {
    this._event = event;
  }
...
export class IntervalsOwnerCanceled extends ethereum.Event {
  get params(): IntervalsOwnerCanceled__Params {
    return new IntervalsOwnerCanceled__Params(this);
  }
}

export class IntervalsOwnerCanceled__Params {
  _event: IntervalsOwnerCanceled;

  constructor(event: IntervalsOwnerCanceled) {
    this._event = event;
  }
...
export class IntervalsOwnerPending extends ethereum.Event {
  get params(): IntervalsOwnerPending__Params {
    return new IntervalsOwnerPending__Params(this);
  }
}

export class IntervalsOwnerPending__Params {
  _event: IntervalsOwnerPending;

  constructor(event: IntervalsOwnerPending) {
    this._event = event;
  }
...
export class IntervalsOwnerUpdated extends ethereum.Event {
  get params(): IntervalsOwnerUpdated__Params {
    return new IntervalsOwnerUpdated__Params(this);
  }
}

export class IntervalsOwnerUpdated__Params {
  _event: IntervalsOwnerUpdated;

  constructor(event: IntervalsOwnerUpdated) {
    this._event = event;
  }
...
export class IntervalsStreamCreated extends ethereum.Event {
  get params(): IntervalsStreamCreated__Params {
    return new IntervalsStreamCreated__Params(this);
  }
}

export class IntervalsStreamCreated__Params {
  _event: IntervalsStreamCreated;

  constructor(event: IntervalsStreamCreated) {
    this._event = event;
  }
...
export class Intervals extends ethereum.SmartContract {
  ...
  initialize(
    ...
    let result = super.call(
      "initialize",
      "initialize(address,uint64,uint64,uint32,uint96,uint256,address,address,address):(address)",
      [
